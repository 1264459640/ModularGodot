...
Provides resource management functionality, including resource loading, caching, memory monitoring and reference tracking
...
### 2. 鎵╁睍鐐圭洃鍚?
`csharp
public class MyResourceSystemExtension : FrameworkExtensionBase, IResourceSystemExtensionPoint
{
    public override void Initialize(IExtensionContext context)
    {
        // 娉ㄥ唽涓烘墿灞曠偣
        RegisterExtensionPoint<IResourceSystemExtensionPoint>(this);
    }
