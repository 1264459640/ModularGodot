...
Provides sequence management functionality, supporting timeline and action sequences
...
### 2. 鎵╁睍鐐圭洃鍚?
`csharp
public class MySequenceSystemExtension : FrameworkExtensionBase, ISequenceSystemExtensionPoint
{
    public override void Initialize(IExtensionContext context)
    {
        // 娉ㄥ唽涓烘墿灞曠偣
        RegisterExtensionPoint<ISequenceSystemExtensionPoint>(this);
    }
